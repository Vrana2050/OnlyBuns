...
import rs.ac.uns.ftn.onlybunsapp.security.auth.RestAuthenticationEntryPoint;
import rs.ac.uns.ftn.onlybunsapp.security.auth.TokenAuthenticationFilter;
import rs.ac.uns.ftn.onlybunsapp.service.impl.CustomUserDetailsService;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/auth/**").permitAll()		// /auth/**
			...
			.antMatchers("/account/**").permitAll()// /api/foo
				...
				.antMatchers("/actuator/**").permitAll()//ZA PROMETHEUS
