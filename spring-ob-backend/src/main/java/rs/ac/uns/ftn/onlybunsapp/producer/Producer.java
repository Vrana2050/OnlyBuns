package rs.ac.uns.ftn.onlybunsapp.producer;
...
public class Producer {
    ...
    public void sendFanoutMessage(String fanoutExchange,String message) {
        rabbitTemplate.convertAndSend(fanoutExchange, "", message);
        System.out.println("Sent message to all agencies: " + message);
    }
}
